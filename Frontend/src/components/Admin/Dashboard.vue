  ...
  <div class="flex min-h-screen bg-gray-100">
    ...
    <div class="ml-64 p-8 w-full">
      ...
      <div class="mb-8 flex space-x-6">
        <router-link 
          to="/admin/dashboard" 
          class="text-lg font-semibold text-blue-600 hover:text-blue-800 transition duration-200 border-b-2 border-transparent hover:border-blue-600"
          active-class="text-blue-800 border-blue-600"
        >
          Dashboard
        </router-link>
        <router-link 
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        <div class="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition duration-300 transform hover:-translate-y-1 bg-gradient-to-br from-green-50 to-white">
        ...
        <div class="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition duration-300 transform hover:-translate-y-1 bg-gradient-to-br from-blue-50 to-white">
          <h3 class="text-lg font-semibold text-gray-700 mb-2">Total Donors</h3>
          <p class="text-3xl font-bold text-blue-600">{{ totalDonors }}</p>
        </div>
        <div class="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition duration-300 transform hover:-translate-y-1 bg-gradient-to-br from-purple-50 to-white">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <router-link 
          to="/admin/donations" 
          class="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition duration-300 transform hover:-translate-y-1 flex items-start space-x-4"
        >
